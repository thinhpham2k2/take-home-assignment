...
import Config.PaperflieDeserializer;

import java.util.ArrayList;

import Model.Hotel;

public class Paperflie {

  private static final String URL = "https://5f2be0b4ffc88500167b85a0.mockapi.io/suppliers/paperflies";
  ...
  public static List<Hotel> fetchData() {
    ...
    try {
      ...
      Gson gson = new GsonBuilder()
          .registerTypeAdapter(Hotel.class, new PaperflieDeserializer())
          .create();
