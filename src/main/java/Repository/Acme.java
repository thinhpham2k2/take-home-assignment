...
import Config.AcmeDeserializer;
...
public class Acme {
  ...
  private static final String URL = "https://5f2be0b4ffc88500167b85a0.mockapi.io/suppliers/acme";
  ...
  public static List<Hotel> fetchData() {
    ...
    try {
      ...
      Gson gson = new GsonBuilder()
          .registerTypeAdapter(Hotel.class, new AcmeDeserializer())
          .create();
